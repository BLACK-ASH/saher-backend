# Graph Report - saher-backend  (2026-08-22)

## Corpus Check
- 237 files · ~76,608 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1187 nodes · 3055 edges · 111 communities (63 shown, 48 thin omitted)
...
## Communities (111 total, 48 thin omitted)

### Community 0 - "api-response.ts"
Cohesion: 0.07
Nodes (71): accountSchemaFinal, AccountT, getAccountByUser(), userSchemaFinal, retrieveCustomAttendace(), retrieveTypeMonthAttendance(), retrieveTypeTodayAttendance(), retrieveTypeWeekAttendance() (+63 more)

### Community 1 - "agent.md project overview"
Cohesion: 0.02
Nodes (102): agent.md project overview, Assistant (Compaction · OmniRoute Auto · 40.6s), Assistant (Saher-Dev · OmniRoute Auto · 0.5s), Assistant (Saher-Dev · OmniRoute Auto · 100.5s), Assistant (Saher-Dev · OmniRoute Auto · 10.1s), Assistant (Saher-Dev · OmniRoute Auto · 10.4s), Assistant (Saher-Dev · OmniRoute Auto · 11.0s), Assistant (Saher-Dev · OmniRoute Auto · 11.3s) (+94 more)

### Community 2 - "admin.routes.ts"
Cohesion: 0.09
Nodes (29): accountBaseSchema, AccountRegisterInput, accountRegisterSchema, accountSchema, AccountUpdateInput, accountUpdateSchema, userSchema, createBankDetailController() (+21 more)

### Community 3 - "auth.routes.ts"
Cohesion: 0.19
Nodes (12): LoginInputSchema, LoginInputType, changeEmailRequestSchema, confirmPasswordSchema, confirmTokenSchema, tokenSchema, getAllSessionController(), logoutAllSessionsController() (+4 more)

### Community 4 - "createKey"
Cohesion: 0.16
Nodes (22): accountGetController(), accountRegisterController(), accountUpdateController(), getAccount(), getAllUsersController(), userDeleteController(), userRestoreController(), userUpdateController() (+14 more)
...
Cohesion: 0.16
Nodes (14): Participant, participantSchema, ParticipantType, Program, programSchema, ProgramType, Workshop, workshopSchema (+6 more)

### Community 7 - "src/index.ts"
Cohesion: 0.10
Nodes (20): adminRouter, attendanceRouter, authRouter, eventRouter, app, httpLogger, httpRequestDuration, httpRequestTotal (+12 more)

### Community 8 - "Notification"
Cohesion: 0.52
...
Cohesion: 0.13
Nodes (23): holidaySchema, holidayUpdateSchema, calendarRouter, createCalendarEventSchema, event, EventT, eventType, updateCalendarEventSchema (+15 more)

### Community 11 - "leave.controller.ts"
Cohesion: 0.08
Nodes (36): LeaveBalance, leaveBalanceSchema, leaveActionTypes, LeaveLog, leaveLogSchema, Leave, leaveSchema, LeaveTypes (+28 more)
...
Cohesion: 0.09
Nodes (26): Mail, mailSchema, Mailtype, UserRole, getInboxMails(), sendMail(), SendMailPayload, sendMailUtilitySchema (+18 more)

### Community 17 - "reimbursement.routes.ts"
Cohesion: 0.05
Nodes (51): AuditLog, auditLogSchema, AuditLogType, Bill, billSchema, billStatus, BillType, modes (+43 more)

### Community 20 - "Fix Report — running summary"
Cohesion: 0.11
Nodes (17): 00-cross-cutting ✅ — commit `72c33ac` (branch `fix/module-fixes`, 2026-08-22), 01-admin ✅ — branch `fix/module-fixes`, 2026-08-22, 02-attendance ✅ (Chunks A–D) — branch `fix/module-fixes`, 2026-08-22, 03-auth ✅ — branch `fix/module-fixes`, 2026-08-22, 04-calendar ✅ — branch `fix/module-fixes`, 2026-08-22, 05-database ✅ (+ 01-admin CRIT completion) — branch `fix/module-fixes`, 2026-08-22, 06-events ✅ — branch `fix/module-fixes`, 2026-08-22, 07-libs ✅ — branch `fix/module-fixes`, 2026-08-22 (+9 more)

### Community 21 - "attendance-report.ts"
Cohesion: 0.24
Nodes (8): connectDb(), Req, Res, logger, getBrowser(), attendanceReportWorker, generateAttendanceReportPdf(), tempPath
...
### Community 38 - "user.model.ts"
Cohesion: 0.14
Nodes (24): changeEmailController(), changeEmailRequestController(), changePasswordController(), changePasswordRequestController(), forgotPasswordController(), forgotPasswordRequestController(), hashToken, revokeUserSessions() (+16 more)
...
### Community 55 - "image.controller.ts"
Cohesion: 0.23
...
Cohesion: 0.18
Nodes (20): getAllHolidayController(), getHolidayController(), allAttendanceController(), getAttendanceById(), getPrograms(), getSingleProgram(), getSingleSession(), addWorkshop() (+12 more)

### Community 58 - "ApiError"
Cohesion: 0.16
Nodes (11): downloadReportController(), REPORT_DIR, attendanceSchema, Session, sessionAttendance, SessionAttendanceType, sessionSchema, SessionType (+3 more)

### Community 59 - "user.ts"
Cohesion: 0.07
Nodes (32): getUser(), shortUserSchema, UserT, meController(), baseSchema, CreateParticipantInputType, UpdateParticipantInputType, addParticipantsToProgramSchema (+24 more)

### Community 60 - "create-first-user.ts"
Cohesion: 0.17
Nodes (13): accountSchema, AccountType, EmployeeType, employeeTypeList, Bank, bankSchema, BankType, meadiaSchema (+5 more)
...
### Community 102 - "attendance-pdf.ts"
Cohesion: 0.70
Nodes (3): formatTime(), createAttendancePdfBody(), formatDate()

### Community 103 - "session.controller.ts"
Cohesion: 0.23
Nodes (12): PushNotificationType, PushSubscription, pushSubscriptionSchema, addSession(), deleteSession(), editSession(), getSessions(), invalidateCalendarCache() (+4 more)
...
Cohesion: 0.11
Nodes (32): Notification, notificationActionTypes, notificationMethod, notificationSchema, notificationScope, NotificationType, notificationTypes, NotificationType (+24 more)

### Community 110 - "redis-utils.ts"
Cohesion: 0.15
Nodes (18): attendanceReportQueue, loginController(), logoutController(), COOKIE_OPTIONS, refreshController(), getSessionMeta(), SessionMeta, generateRefreshToken() (+10 more)

### Community 113 - "workshop.schema.ts"
Cohesion: 0.29
...
### Community 115 - "events.routes.ts"
Cohesion: 0.23
Nodes (13): addParticipantController(), deleteParticipantController(), editParticipantController(), getParticipantByIdController(), getParticipants(), undoDeleteParticipantController(), participantResponseSchema, participantSchema (+5 more)

## Knowledge Gaps
- **458 isolated node(s):** `name`, `version`, `description`, `main`, `dev` (+453 more)
...
- **Why does `normalizeDoc()` connect `.success` to `api-response.ts`, `admin.routes.ts`, `createKey`, `session.controller.ts`, `Notification`, `notice.controller.ts`, `calender.controller.ts`, `leave.controller.ts`, `setCache`, `payroll.routes.ts`, `authorize.ts`, `reimbursement.routes.ts`, `events.routes.ts`, `user.ts`?**
  _High betweenness centrality (0.050) - this node is a cross-community bridge._
- **Why does `ApiError` connect `ApiError` to `api-response.ts`, `admin.routes.ts`, `auth.routes.ts`, `createKey`, `session-attendance.controller.ts`, `src/index.ts`, `calender.controller.ts`, `leave.controller.ts`, `payroll.routes.ts`, `authorize.ts`, `reimbursement.routes.ts`, `user.model.ts`, `notice.controller.ts`, `image.controller.ts`, `.success`, `user.ts`, `session.controller.ts`, `env.ts`, `setCache`, `redis-utils.ts`, `events.routes.ts`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
- **Why does `ApiResponse` connect `api-response.ts` to `admin.routes.ts`, `auth.routes.ts`, `createKey`, `user.model.ts`, `session-attendance.controller.ts`, `session.controller.ts`, `notice.controller.ts`, `calender.controller.ts`, `leave.controller.ts`, `setCache`, `redis-utils.ts`, `payroll.routes.ts`, `authorize.ts`, `reimbursement.routes.ts`, `events.routes.ts`, `.success`, `ApiError`, `user.ts`?**
