...
export const getAllUserController = async (req: Request, res: Response) => {
  ...
  // Standardize both to Kolkata day strings via helper; avoids server-TZ hour-boundary bugs
  const startStr = standardDateString(startDate);
  const endStr = standardDateString(endDate);
