...
import { attendanceCorrectionSchema, attendanceCorrectionHandleSchema } from "./correction/correction.schema.js"
import { createAttendanceCorrectionController, getAllAttendanceCorrectionController, getAttendanceCorrectionById, getAttendanceCorrectionController, handleAttendanceCorrectionController } from "./correction/correction.controller.js"
...
attendanceRouter.put("/attendance-correction/:id", authorize("update", "attendance-correction"), validate(attendanceCorrectionHandleSchema), handleAttendanceCorrectionController)
