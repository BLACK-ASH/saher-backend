...
export const addHolidayController = async (req: Request, res: Response) => {
  ...
  return res.status(201).json({ success: true, message: "The holiday record has been added successful", data: holiday.toJSON() })
}
...
export const updateHolidayController = async (req: Request, res: Response) => {
  ...
  return res.status(200).json({ message: "Holiday Record Updated Successful", success: true, data: updateData.toJSON() })
}
...
export const getHolidayController = async (req: Request, res: Response) => {
  ...
  return res.status(200).json({ message: "Holiday Retrive Successful", success: true, data: record })
}
...
export const getAllHolidayController = async (req: Request, res: Response) => {
  ...
  return res.status(200).json({ message: "All Holidays Retrive Successful.", data: holidays, success: true })
}
...
export const deleteHolidayController = async (req: Request, res: Response) => {
  ...
  return res.status(200).json({ message: "The Holiday has been deleted successful.", success: true })
}
