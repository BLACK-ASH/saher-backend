...
export const reimbursementSchema = z.object({
    billImg: objectId,
    billAmount: z.number(),
    dateOfPayment: dateField.refine(
...
export const reimbursementReviewSchema = reimbursementSchema.omit({ billImg: true, billAmount: true, dateOfPayment: true, description: true })
    .extend({
        id: objectId,
        status: z.enum(reimbursementStatus)
    });
