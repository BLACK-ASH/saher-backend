...
export const programmeResponsiveSchema = z.object({
  title: z.string(),
...
export const getProgrammesSchema = z.array(programmeResponsiveSchema);
export const getSingleProgrammeSchema = programmeResponsiveSchema;
