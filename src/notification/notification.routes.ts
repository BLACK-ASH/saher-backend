...
import { createGlobalNotificationController, createIndividualNotificationController, deleteAllNotificationController, deleteNotificationController, getAlltNotificationController, getLatestNotificationController, updateNotificationController } from "./notification.controllers.js";
...
notificationRouter.post("/systemNotification" , authorize("write","notification") , createIndividualNotificationController)
