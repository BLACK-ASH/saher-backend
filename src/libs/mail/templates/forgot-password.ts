...
export const forgotPasswordTemplate = ({ name, url, expiryTime }: Props): string => {
...
<html>
  <head>
    <meta charset="UTF-8" />
    <title>Saher - Password Reset</title>
  </head>
    ...
    <tr>
      <td style="padding:0 24px 24px;">
        ...
        <p style="font-size:14px; color:#374151; margin:0 0 20px;">
          To proceed securely, click the button below. This will open a password reset form where you can set a new password.
        </p>
        ...
        <p style="font-size:13px; color:#b91c1c;">
          ⚠️ This link will expire in ${safeExpiryTime}. If you did not request this, please ignore this email.
        </p>
